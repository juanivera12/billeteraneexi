                      ...
                      <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                        <div className="grid grid-cols-2 gap-2 text-xs">
                          <div>
                            ...
                            <span className="font-medium">${challenge.totalAmount.toLocaleString()}</span>
                          </div>
                          <div>
                            <span className="text-muted-foreground">Duración: </span>
                            <span className="font-medium">{challenge.duration} {challenge.durationType === 'weeks' ? 'semanas' : 'días'}</span>
                          </div>
                ...
                {[
                  ...
                  <div key={category.name} className="space-y-2">
                    <div className="flex justify-between items-center text-sm">
                      ...
                      <span className={category.spent > category.budget ? 'text-red-600' : 'text-gray-600'}>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700">
                        La IA detectó que ahorraste $5,200 este mes usando rutas optimizadas y cupones automáticos.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-yellow-900 flex items-center">
                        ...
                        <Sparkles className="w-4 h-4 ml-2 text-yellow-600" />
                      </h4>
                      <p className="text-sm text-yellow-700">
                        La IA sugiere cambiar tu suscripción de streaming. Ahorro potencial: $890/mes
                      </p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">
                        Con los ajustes actuales, podrás ahorrar $18,500 extra este mes. La IA continúa optimizando.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                    ...
                    <div className="text-xs text-green-600">Estado: En camino | Progreso: 63%</div>
                  </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded-lg border">
                  ...
                  <p className="text-sm text-gray-600">3 metas activas</p>
                  <div className="text-xs text-green-600 mt-1">✓ $520,000 total ahorrado</div>
                </div>
                <div className="bg-white p-4 rounded-lg border">
                  <div className="flex items-center justify-between mb-2">
